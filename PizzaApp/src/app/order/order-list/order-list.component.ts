...
export class OrderListComponent implements OnInit {
  ...
  ngOnInit() {
    const pizzasOrdersObservable = this.orderService.getPizzas().map((pizzas: IPizza[]) => {
    ...
    Observable.zip(pizzasOrdersObservable, customerObservable, (pizzaOrders: IPizzaOrder[], customer: ICustomer) => {
      return {
